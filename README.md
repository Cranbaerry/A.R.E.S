...
I have gone about validating the latest V7.2 package with Microsoft, if a false positive is detected please follow the insructions within the "Submission" folder <<This also works as proof that all files are safe as they were manually reviewed by a Microsoft employee!
...
Features:
    ...
    -Log avatars manually via their preview frame
