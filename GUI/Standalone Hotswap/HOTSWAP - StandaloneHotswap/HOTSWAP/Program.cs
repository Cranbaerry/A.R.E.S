    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (work == "d")
            {
                ...
                Console.WriteLine("This HOTSWAP.exe file has been modified to better\nsuit 'StandaloneHotswap' and is different then\nthe one bundled in ARES");
                ...
                Console.WriteLine("===================================================");
                Console.ForegroundColor = ConsoleColor.White;
                DecompressToFileStr(ABF, "decompressed.LargestBundle");
                Console.ForegroundColor = ConsoleColor.White;
            ...
            if (work == "c")
            {
                ...
                Console.WriteLine("===================================================");
                Console.ForegroundColor = ConsoleColor.White;
                CompressBundle(dir, "compressed.LargestBundle");
                Console.ForegroundColor = ConsoleColor.White;
