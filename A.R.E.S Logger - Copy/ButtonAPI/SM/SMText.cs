...
namespace ARES.Utils.API.SM
{
    public class SMText
    {
        ...
        {
            textObject = Object.Instantiate(APIStuff.GetSocialMenuInstance().transform.Find("Settings/AudioDevicePanel/MicDeviceText").gameObject, location, false);
            text = textObject.GetComponent<Text>();
            textObject.name = $"SMText-{APIStuff.RandomNumbers()}";
